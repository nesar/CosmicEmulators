...
xlim1 = 10
xlim2 = 15
t = np.logspace(np.log10(10**xlim1), np.log10(10**xlim2), 500)[::10]        #  Should be the parameters
#y = np.loadtxt('Data/HMFTestData.txt')[5:]               # Should be W
...
y = np.loadtxt('Data/W_for2Eval.txt', dtype=float)[0]  # 
