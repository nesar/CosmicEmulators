# -*- coding: utf-8 -*-
"""
Calibration example given here -  http://dan.iel.fm/george/current/user/model/

http://dan.iel.fm/george/current/user/model/#assuming-white-noise

2 methods are shown - with and without modeling noise. 

I have reduced number of sample points to increase speed
...
def model(params, t):    # Create mock data
    amp, loc, sig2 = params
...
plt.savefig("Plots/Sample_fig1.png", dpi=150)
...
plt.savefig("Plots/Sample_fig4.png", dpi=150)

# Make the corner plot.
fig = triangle.corner(samples[:, 2:], truths=truth, labels=labels)
fig.savefig("Plots/Sample_fig5.png", dpi=150)
